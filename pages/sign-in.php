        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form role="form" id="pur" method="POST" action="app/user/login"class="text-start">
              <?php 
                 if($_SESSION['bitcrow_status']!="") {
                  echo '  <font style="color:green"> <b>Registration '.$_SESSION['bitcrow_status'].'full</b> Click here to verify your email</font>';
                  $_SESSION['bitcrow_status']="";
                 }
                

                 if($_SESSION['bitcrow_loginerror']=='invaliddetails') {
                  echo '  <font style="color:red;"> <b>Invalid Details Supplied</b></font>';
                  $_SESSION['bitcrow_loginerror']="";
                 }
                
                                 
                 if($_SESSION['bitcrow_loginerror']=="email_versent") {
                  echo '  <font style="color:red"> <b>Registration Successfull</b> Check your email inbox or spam box to verify your Account</font>';
                   $_SESSION['bitcrow_loginerror']="";
                 }
               


               if($_SESSION['bitcrow_loginerror']=='email_confirm') {
                  echo '  <font style="color:green"> <b>Email Confirmed Successfull</b> Kindly Login</font>';
                  $_SESSION['bitcrow_loginerror']="";
                 }
                

                 if($_SESSION['bitcrow_loginerror']=='email_confirmed') {
                  echo '  <font style="color:green"> <b>User already exits</b> please Kindly verify your email</font>';
                  $_SESSION['bitcrow_loginerror']="";
                 }
                ...
                <div class="input-group input-group-outline my-3">
                  ...
                  <input value="<?php echo clean($encrypted_value);?>" name="ye_ran" id="ye _ran" type="hidden"  />
                  <script>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a href="<?php echo $social; ?>" class="font-weight-bold text-white" target="_blank"><?php echo $sname; ?></a>
            ...
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                ...
                <li class="nav-item">
                  <a href="about" class="nav-link text-white" target="_blank">About Us</a>
                </li>
                <!-- <li class="nav-item">
