        ...
        <div class="container">
          <div class="row">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('assetss/images/banner-bg.jpg'); background-size: cover;">
                        </div>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  ...
                  <font style="color:red">  <p><b><?php if($_SESSION['bitcrow_regerror']=='invaliddetails') {
                   echo"<br/>User details may already exist please try another"; 
                   $_SESSION['bitcrow_regerror']='';

                  }
                  ?></b></p></font>
                </div>
                <div class="card-body">
                  <form role="form" id="pur" action="app/user/register" method="POST">
