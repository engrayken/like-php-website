...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="tables">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Free Credit</li>
          </ol>
          <!-- <h6 class="font-weight-bolder mb-0">Free Credit</h6> -->
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Get Free Credit</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                
              <h6 style="color:blue; padding-left:5px"> Select Feature</h6>

<select id="select-feature" name="select-feature" size="1" class="width-250 a-left" onchange="ChangeNetwork()" style="border:0px">
<option value="askfml"  >AskFm Likes </option><option value="facebookcom"  >Facebook Comments </option>
<option value="facebook"  selected="selected"   class="green" >Facebook Likes</option>
...
<br/><br/>
<small style="color:blue; padding-left:5px">earn free credits </small>
 <h6 style="color:blue; padding-left:5px"> Free Credits By Facebook Likes</h6>

 <p style="padding-left:5px">
 1. Click Like button<br/>
 2. Like it on Facebook<br/>
 3. Click Confirm button<br/>
</p>
<br/>
<h6 style="color:blue; padding-left:5px; text-align:center"> The magic happen here</h6>
